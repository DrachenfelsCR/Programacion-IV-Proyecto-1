 ...
 * @author David
 */
@WebServlet(name = "mainPageController", urlPatterns = {"/presentation/mainPage"})
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           ...
           request.setAttribute("model", new Model());
            RequestDispatcher reqDispatcher = request.getRequestDispatcher("presentation/mainPageView.jsp");
